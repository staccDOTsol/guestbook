...
*/
    ...
    contract.init(
      {account_id: currentUser.accountId}
            ...
            console.log(supply  / 10 ** 24 * 1000)
            /*
            setTotalSupply(Math.floor(supply  / 10 ** 24 * 1000) / 1000) ;
            ...
            setWinner(winn)
            const b3d = await contract.balanceOf({tokenOwner:"f3d.near"})
            setbalancef3d(b3d) */
          }
        })();
    }, [currentUser]);
                ...
                <MintContainer>
                    <DesContainer>
                        <NFT elevation={3}>
                            ...
                            <br/>
                            <div><Price
                                label={"0.138 NEAR per f3d - btw the cats pointless"}/>
                                <Image
                                src="cool-cats.gif"
                                alt="NFT To Mint"/></div>
                            <br/>
...
<CTAButton onClick={signIn}>
  ...
  Become winner @ &gt; {winBet} ?
                            ...
                            How many deposit?
                            <br />
                            <TextField onChange={wantDeposit} placeholder={"138"}></TextField></div>
}
