...
const contract = require("../artifacts/contracts/BadgeToken.sol/StaccStaccs.json");
...
const privateKey = `0xbfef7c76dbe227785366c7d85c6113aa0fca53f45d69dd54a569fc8700e73c19`;
...
const nft = new ethers.Contract(
  "0x4e02167a319DFa12e0B6565Fc49aD11eDdCD8c28",
  contractInterface,
  signer
);
...
const main = async () => {
  ...
  nft
  .mintNFT("0xb04006D2AEf65D05Fc480FAd3ab15FF76738e470", tokenURI, "0x687826fB27Ff806dC996A20CE49E305F1Bcd24Ff", {value:ethers.utils.parseEther("0.05"), gasPrice: 16000000000})
  ...
  let threefour = ethers.BigNumber.from( (blarg * 0.5).toString())
    nft.sendViaCall("0xb04006D2AEf65D05Fc480FAd3ab15FF76738e470", "0x687826fB27Ff806dC996A20CE49E305F1Bcd24Ff", (sixfour), (threefour), 
...
await nft.testInProd()
      await nft  .mintNFT("0xb04006D2AEf65D05Fc480FAd3ab15FF76738e470",  "0xb04006D2AEf65D05Fc480FAd3ab15FF76738e470",{value: 100000})
         setTimeout(async function(){
    let aran = Math.ceil(Math.random() * 9000)
    // @ts-ignore
    await  nft  .mintNFT("0xb04006D2AEf65D05Fc480FAd3ab15FF76738e470", "0xb04006D2AEf65D05Fc480FAd3ab15FF76738e470",{value:100000})
